...
def main():
    ...
    print(f"Naive MVG model accuracy: {accuracy:.1f}%")
    print(f"Naive MVG model error rate: {error_rate:.1f}%\n")
    ...
    print(f"Log naive MVG model accuracy: {accuracy:.1f}%")
    print(f"Log naive MVG model error rate: {error_rate:.1f}%\n")
