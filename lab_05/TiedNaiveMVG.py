...
def tied_naive_MVG_classifier(D, mean_array, within_class_cov, prior):
    ...
    joint_sol = np.load(os.getcwd() + "/lab_05/data/SJoint_TiedNaiveBayes.npy")
    ...
    posterior_sol = np.load(os.getcwd() + "/lab_05/data/Posterior_TiedNaiveBayes.npy")
...
def tied_naive_MVG_log_classifier(D, mean_array, within_class_cov, prior):
    ...
    log_S_Joint_sol = np.load(os.getcwd() + "/lab_05/data/logSJoint_TiedNaiveBayes.npy")
    ...
    log_marginal_sol = np.load(os.getcwd() + "/lab_05/data/logMarginal_TiedNaiveBayes.npy")
    ...
    log_posterior_sol = np.load(os.getcwd() + "/lab_05/data/logPosterior_TiedNaiveBayes.npy")
