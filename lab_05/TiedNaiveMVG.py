...
def main():
    ...
    print(f"Tied naive MVG model accuracy: {accuracy:.1f}%")
    print(f"Tied naive MVG model error rate: {error_rate:.1f}%\n")
    ...
    print(f"Log tied naive MVG model accuracy: {accuracy:.1f}%")
    print(f"Log tied naive MVG model error rate: {error_rate:.1f}%\n")
