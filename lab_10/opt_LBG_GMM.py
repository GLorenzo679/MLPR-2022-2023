...
def EM_GMM(X, gmm, psi, threshold=1e-6):
    new_gmm = gmm
    avg_log_ll = 0
...
def LBG(X, gmm, psi):
    ...
    for _ in range(2):
        opt_gmm = EM_GMM(X, GMM_split(opt_gmm), psi)
...
def main():
    ...
    opt_gmm = LBG(dataset_4D, GMM_1, psi)
